 ...
 */
int IM948::Cmd_PackAndTx(U8 *pDat, U8 DLen)
{
 ...
 */
void IM948::Cmd_12(U8 accStill, U8 stillToZero, U8 moveToZero, U8 isCompassOn, U8 barometerFilter, U8 reportHz, U8 gyroFilter, U8 accFilter, U8 compassFilter, U16 Cmd_ReportTag)
{
    U8 buf[11] = {0x12};
    buf[1] = accStill;
    buf[2] = stillToZero;
 ...
 */
void IM948::Cmd_20(S8 *accMatrix, S8 *comMatrix)
{
    U8 buf[19] = {0x20};
 ...
 */
void IM948::Cmd_22(const char *bleName)
{
    U8 buf[17] = {0x22};
 ...
 */
void IM948::Cmd_24(U8 PowerDownVoltageFlag, U8 charge_full_mV, U8 charge_full_mA, U8 charge_mA)
{
    U8 buf[5] = {0x24};
 ...
 */
void IM948::Cmd_2C(U8 idleToPowerOffTime)
{
    U8 buf[2] = {0x2C};
 ...
 */
void IM948::Cmd_2E(U8 DisableBleSetNameAndCahrge)
{
    U8 buf[2] = {0x2E};
 ...
 */
void IM948::Cmd_33(U8 AccRange, U8 GyroRange)
{
    U8 buf[3] = {0x33};
 ...
 */
void IM948::Cmd_35(U8 GyroAutoFlag)
{
    U8 buf[2] = {0x35};
 ...
 */
void IM948::Cmd_37(U8 EcoTime_10s)
{
    U8 buf[2] = {0x37};
    buf[1] = EcoTime_10s;
    Dbp("\r\nset EcoTime_10s--\r\n");
 ...
 */
void IM948::Cmd_50(U8 *TxBuf, U8 TxLen)
{
 ...
 */
void IM948::Cmd_51(U8 isReportCycle)
{
    U8 buf[3] = {0x51};
    if (isReportCycle)
    {
 ...
 * @param DLen 数据体的长度
 */
void IM948::Cmd_RxUnpack(U8 *buf, U8 DLen)
{
    U16 ctl;
    U8 L;
    U8 tmpU8;
    ...
    case 0x11: // 获取订阅的功能数据 回复或主动上报
    {
        ...
        { // 角速度xyz 使用时需*scaleAngleSpeed rad/s
            ...
            angular_vel = tmpAbs * 0.0174532925;
            angular_vel_x = tmpX * 0.0174532925; // 单位rad/s
            angular_vel_y = tmpY * 0.0174532925; // 单位rad/s
            angular_vel_z = tmpZ * 0.0174532925; // 单位rad/s
        }
        if ((ctl & 0x0008) != 0)
...
// 初始化串口
bool IM948::init(int baud_rate, const std::string &port)
{
    port_name = port;
...
speed_t IM948::get_baud_rate(int baud_rate)
{
    switch (baud_rate)
    {
    case 500000:
...
bool IM948::start()
{
    ...
    running = true;
    communication_thread = std::thread(&IM948::communication_loop, this);
    return true;
}
